...
def Vari():
    return ['x+1','|x|','x','x-1','-x','2x','3x','sin', 'cos', 'tan', 'asin', 'acos', 'atan', 'sinh', 'cosh', 'tanh', 'asinh', 'acosh', 'atanh','exp', 'exp1', 'exp2','expm1','relu', 'sigmoid', 'tanh', 'softplus', 'softsign', 'elu', 'selu', 'celu', 'gelu', 'hardshrink', 'hardtanh', 'leakyrelu', 'logsigmoid', 'rrelu', 'sqrt', 'square', 'cube', 'log', 'log2', 'log10']
...
def generate_population():
    ...
    for i in range(population_size):
        ...
        vpopulation = np.random.choice(Vari(), size = varinum)
        ...
        population.append([vpopulation,epopulation])
        #population.append([npopulation,epopulation])
    return population
     

    
    #gpu cost that prifiling cpu time of new squash function
def gpu_cost():
    """ return the gpu cost of population. """
